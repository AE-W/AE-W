...
My research interests lie in controllable generative models and unsupervised multimodal perception systems.

% ===== Education =====
\section{Education}
\eduentry{B.S., Computer Science}{University of Michigan}{}{2023 -- Present}{Advisor: \href{https://andrewowens.com}{Prof. Andrew Owens}}

% ===== Research Experience =====
\section{Research Experience}
\cventry{\textbf{HidingSound: Adaptive Soundscape Generation for Online Noise Coverage}}{2025}{%
\textit{Advised by Prof. Andrew Owens}\par
\begin{itemize}
\item A real-time adaptive soundscape generation framework for sound masking, improving upon traditional soundscape design to better hide unwanted noise in real-world environments
\end{itemize}
}
